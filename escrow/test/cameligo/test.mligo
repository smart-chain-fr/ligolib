let test =
  ...
  let initial_storage = {
    ...
    escrows = Map.literal[("escrow1", {currency = "TZBTC"; amount = 100n; buyer = ("tz1hNVs94TTjZh6BZ1PM5HL83A7aiZXkQ8ur" : address); seller = ("tz1c6PPijJnZYjKiSQND4pMtGMg6csGeAiiF" : address); escrowContract = (None : address option); cancelled = false; released = false; paid = true })];
    judges = (Map.empty : (nat, address) map);
    votingContract = ("KT1BEqzn5Wx8uJrZNvuS9DVHmLvG9td3fDLi" : address)} in
  let (taddr, _, _) = Test.originate main initial_storage 0tez in
  let current_storage : storage = Test.get_storage taddr in
