...
function expandMacros(ex, opt) {
    ...
    if (unpairRe.test(ex.prim)) {
        if (proto === michelson_types_1.Protocol.PtEdo2Zk || proto === michelson_types_1.Protocol.PsFLorena || proto === michelson_types_1.Protocol.PtGRANADs || proto === michelson_types_1.Protocol.PtHangzH) {
            if (ex.prim === "UNPAIR") {
                return ex;
            }
            if (assertArgs(ex, 0)) {
