...
module Preamble = struct
    [@inline]
    let prepare_new_proposal (params: Parameter.Types.proposal_params) (storage: Storage.Types.t) : Storage.Types.proposal = 
    ...
    [@inline]
    let retrieve_a_proposal (proposal_number: Parameter.Types.proposal_number) (storage: Storage.Types.t) : Storage.Types.proposal = 
        let () = Conditions.only_signer storage in
...
type return = operation list * Storage.Types.t

(**
 * Proposal creation
 *)
let create_proposal (params : Parameter.Types.proposal_params) (storage : Storage.Types.t) : return = 
 ...
 * Proposal signature
 *)
let sign_proposal (proposal_number : Parameter.Types.proposal_number) (storage : Storage.Types.t) : return =
    ...
    let operations = FA12.perform_operations proposal in

    (operations, storage)

// ===============================================================================================

let main (action, storage : request) : return =
    match action with
