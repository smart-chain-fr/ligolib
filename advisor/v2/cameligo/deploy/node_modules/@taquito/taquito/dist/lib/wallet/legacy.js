    ...
    LegacyWalletProvider.prototype.mapTransferParamsToWalletParams = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = types_1.attachKind;
                        return [4 /*yield*/, params()];
                    case 1: return [2 /*return*/, _a.apply(void 0, [_b.sent(), types_1.OpKind.TRANSACTION])];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = types_1.attachKind;
                        return [4 /*yield*/, params()];
                    case 1: return [2 /*return*/, _a.apply(void 0, [_b.sent(), types_1.OpKind.ORIGINATION])];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = types_1.attachKind;
                        return [4 /*yield*/, params()];
                    case 1: return [2 /*return*/, _a.apply(void 0, [_b.sent(), types_1.OpKind.DELEGATION])];
                }
            });
        });
    };
